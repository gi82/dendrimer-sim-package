...
if [ $# -ne "$ARGS" ]
then
	echo "Please pass 1: initial distance as argument 2:TaskId"
exit
fi
INIDIST=$1
EXEC=eff
...
MORSECC="$CC 0.714 6.400 1.00 0.3 2.4"
MORSECS="$CS 0.014 19.20 1.25 0.8 2.4"
MORSESS="$SS 0.014 19.20 1.50 1.0 2.4"
...
SIMUL1="$RUNDIR/inter2_D7_G${G}F${F}/Rini${INIDIST}"
